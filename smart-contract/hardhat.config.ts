...
// Setup Polygon testnet network
if (process.env.NETWORK_POLYGON_TESTNET_URL !== undefined) {
  config.networks!.polygonTestnet = {
    url: process.env.NETWORK_POLYGON_TESTNET_URL,
    accounts: [process.env.NETWORK_POLYGON_TESTNET_PRIVATE_KEY!],
  }
}

// Setup Polygon mainnet network
